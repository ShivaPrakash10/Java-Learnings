...
1) What is collection
	...
	* In collections we dont use primitive datatypes but Wrapper classes of the same
...
2) DisAdvantages in array
	...
	* array can hold both primitive and objects
	...
	* array is not implemented with any structural data structures, so there is no readymade mathods are available
	* 
...
3) Advantages of collection
	...
	* Can have both hetro and homogeneous data (single collection can have, int, String and char but all in the form of Object)
...
6) Set Interface
	...
	* Classes which extends List Interface are, HashSet, LinkedHashSet, TreeSet(Also implements SortedSet)
	* Useful methods 
	* 	includes all methods in Collection interface
	* 	of()
	* 	of(E e1)
